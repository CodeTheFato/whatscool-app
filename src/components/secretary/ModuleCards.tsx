  ...
  const modules = [
    {
      icon: Users,
      title: "Alunos",
      description: "Gerenciar registros e informações dos alunos",
      iconBg: "bg-blue-50",
    ...
    },
    {
      icon: School,
      title: "Turmas",
      description: "Criar e organizar turmas escolares",
      iconBg: "bg-green-50",
    ...
    },
    {
      icon: Link2,
      title: "Atribuições",
      description: "Vincular professores e alunos às turmas",
      iconBg: "bg-purple-50",
    ...
    },
    {
      icon: CreditCard,
      title: "Pagamentos",
      description: "Gerenciar mensalidades e gerar faturas",
      iconBg: "bg-teal-50",
    ...
    },
    {
      icon: FileCheck,
      title: "Autorizações",
      description: "Gerenciar saídas e excursões",
      iconBg: "bg-orange-50",
