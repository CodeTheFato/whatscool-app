      ...
      >
        ...
        <SheetHeader className="px-6 pt-6 pb-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle className="text-lg">Nova comunicação</SheetTitle>
          ...
          <div className="flex bg-gray-100 rounded-xl p-1 gap-1 mt-4">
            <button
        ...
        <div className={`px-6 pb-4 ${isComunicado && sendViaWhatsApp ? "grid grid-cols-5 gap-6" : ""}`}>
          {/* ===== FORM COLUMN ===== */}
          <div className={`space-y-5 ${isComunicado && sendViaWhatsApp ? "col-span-3" : ""}`}>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3 rounded-xl border-2 transition-all ${recipientType === "turma"
                  ? "border-blue-400 bg-blue-50 shadow-sm"
                  : "border-transparent bg-gray-50 hover:bg-gray-100"
                  }`}
              >
                <School
                  className={`h-5 w-5 mx-auto mb-1.5 ${recipientType === "turma" ? "text-blue-600" : "text-gray-400"}`}
                />
                <span className={`text-xs font-medium ${recipientType === "turma" ? "text-blue-700" : "text-gray-500"}`}>
                  Turma Inteira
                </span>
              </button>
              <button
                ...
                className={`p-3 rounded-xl border-2 transition-all ${recipientType === "aluno"
                  ? "border-purple-400 bg-purple-50 shadow-sm"
                  : "border-transparent bg-gray-50 hover:bg-gray-100"
                  }`}
              >
                <User
                  className={`h-5 w-5 mx-auto mb-1.5 ${recipientType === "aluno" ? "text-purple-600" : "text-gray-400"}`}
                />
                <span
                  className={`text-xs font-medium ${recipientType === "aluno" ? "text-purple-700" : "text-gray-500"}`}
                >
                  Aluno Específico
                </span>
              </button>
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              {isComunicado ? "Título do comunicado *" : "Assunto (opcional)"}
            </Label>
            <Input
          ...
          <div className="space-y-0">
            ...
            >
              <Textarea
                ...
                className="min-h-[120px] resize-none border-0 focus-visible:ring-0 rounded-b-none"
                value={message}
          ...
          {isComunicado && (
            <>
              ...
              <div className="space-y-4">
                <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Opções</Label>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-sm font-medium">Permitir respostas</p>
          ...
          {/* ===== PREVIEW WHATSAPP (side column) ===== */}
          {isComunicado && sendViaWhatsApp && (
            <div className="col-span-2">
              <div className="sticky top-0 space-y-4">
                <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Preview WhatsApp</p>
                <div className="bg-[#e5ddd5] rounded-xl p-4">
                  <div className="bg-white rounded-2xl rounded-tl-sm p-4 shadow-md">
        ...
        <SheetFooter className="border-t px-6 py-4">
          <Button
            ...
            className={`w-full gap-2 shadow-lg h-11 text-base font-semibold ${isComunicado
